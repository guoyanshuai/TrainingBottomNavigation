package fei.trainingbottomnavigation;
...
public class ThreeButtonsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomBar.setItemsFromMenu(R.menu.menu_three_button, new OnMenuTabSelectedListener() {
            @Override
        ...
        bottomBar.setActiveTabColor("#C2ff5B");
